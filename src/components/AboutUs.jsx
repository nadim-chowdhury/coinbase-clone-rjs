        ...
        <div className="flex gap">
          <div className="info flex column gap a-start j-center">
            ...
            <p className="subdue">
              ...
              Molestiae quidem laboriosam, sit officia, pariatur sed fugiat quas
              ratione eaque praesentium dolorum expedita nulla aperiam ad.
              Iusto, dolores itaque. Facere, rem!
            </p>
